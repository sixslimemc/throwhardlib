...
data modify storage throwhardlib:in calculate.force set from storage test: force
...
data modify storage six:in add.numbers append from storage throwhardlib:out calculate.result
data modify storage six:in add.numbers append from entity @s Pos
