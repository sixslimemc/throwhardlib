...
data modify storage six:in sum.numbers append from storage throwhardlib:_ v.calculate.magnitude
data modify storage six:in sum.numbers append from storage throwhardlib:_/out randomf.result
